...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	NSString *userName = [[storedCredentials allKeys] firstObject];
...
-(void)sessionDidLoginSuccessfully:(SPSession *)aSession {
	...
	[SPAsyncLoading waitUntilLoaded:aSession withKeyPaths:@[@"user"] timeout:kSPAsyncLoadingDefaultTimeout then:^(NSArray *loadedItems, NSArray *notLoadedItems) {
